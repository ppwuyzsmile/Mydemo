...
#define LTC_NO_TEST
#define LTC_NO_ROLC         //notice It may make some error
...
//#define LTC_NO_PRNGS
	...
	extern void *pvPortMalloc( size_t xWantedSize );
	extern void *pvPortCalloc (size_t n,size_t size);
	extern void *pvPortRealloc(void* pIn,size_t xWantedSize);
